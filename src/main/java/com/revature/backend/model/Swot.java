...
public class Swot {
	...
	public Swot(int id, Associate associate_id, Manager manager, Timestamp createdOn, Timestamp lastModified) {
		super();
		this.id = id;
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof Swot))
			return false;
		Swot swot = (Swot) o;
		return getId() == swot.getId() && Objects.equals(getAssociate(), swot.getAssociate())
	...
	public String toString() {
		return "SWOT_Analysis(id=" + this.getId() + ", associate=" + this.getAssociate() + ", created_by="
				+ this.getManager() + ", created_on=" + this.getCreatedOn() + ", last_modified="
