...
public class Associate {
  ...
  public boolean equals(Object o) {
    ...
    return getId() == associate.getId() && Objects.equals(getSalesforceId(), associate.getSalesforceId())
        && Objects.equals(getEmail(), associate.getEmail()) && Objects.equals(getFirstName(), associate.getFirstName())
        && Objects.equals(getLastName(), associate.getLastName())
        && Objects.equals(getManager(), associate.getManager()) && Objects.equals(getBatch(), associate.getBatch())
        && getStatus() == associate.getStatus();
  }

  @Override
  public int hashCode() {
    return Objects.hash(getId(), getSalesforceId(), getEmail(), getFirstName(), getLastName(), getManager(), getBatch(),
        getStatus());
  }

  public String toString() {
    return "Associate(id=" + this.getId() + ", salesforce_id=" + this.getSalesforceId() + ", email=" + this.getEmail()
        + ", first_name=" + this.getFirstName() + ", last_name=" + this.getLastName() + ", manager_id="
        + this.getManager() + ", batch_id=" + this.getBatch() + ", status=" + this.getStatus() + ")";
  }
}
